...
echo ${PASSPHRASE} | seid tx distribution withdraw-rewards ${SEI_WALLET_ADDRESS} --commission --from openzeppelin --chain-id pacific-1 --gas-adjustment 1.4 --gas auto --gas-prices 0.02usei -y
